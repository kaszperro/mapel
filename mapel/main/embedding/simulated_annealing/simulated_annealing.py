...
from mapel.main.embedding.initial_positions import initial_place_points
from mapel.main.embedding.simulated_annealing.simulated_annealing_energy import get_total_energy
